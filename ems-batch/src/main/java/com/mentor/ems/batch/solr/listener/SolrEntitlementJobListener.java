...
@Component
public class SolrEntitlementJobListener implements ItemReadListener<List<EntitlementSearchDTO>>,StepExecutionListener,
        JobExecutionListener,
        ChunkListener, SkipListener<String, String>, ItemWriteListener<EntitlementSearchDTO> {

    private static final Logger LOGGER = LoggerFactory.getLogger(SolrEntitlementJobListener.class);
