...
public class SolrEntitlementReprocessChunkListener implements JobExecutionListener {
	
	@Autowired
	private EMSJobDAO emsJobDAO;
	

	private static final Logger LOGGER = LoggerFactory.getLogger(SolrEntitlementReprocessChunkListener.class);
	...
	public void afterJob(JobExecution jobExecution) {
		...
		int count;
		try {
			count = emsJobDAO.updateFailedJobStatus(EMSCommonConstants.SOLR_ENTITLEMENT_REPROCESSING_TYPE_JOB);
